# File: git_consts.py
# Copyright (c) 2017-2021Splunk Inc.
#
...
GIT_USERNAME_AND_PASSWORD_REQUIRED = "Username and password are required in case of http(s) URI"
